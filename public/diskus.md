...
```http
POST https://REDACTED_PROJECT_ID.supabase.co/functions/v1/os-lunar-diskus-create-thread
...
```http
POST https://REDACTED_PROJECT_ID.supabase.co/functions/v1/os-lunar-diskus-create-post
Authorization: Bearer <api_key>
Content-Type: application/json
apikey: <public-anon-key>
